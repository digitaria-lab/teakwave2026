...
<div class="profile-hero-visual" data-banner-placement="profile" style="border-radius: var(--radius-xl);background: url(./assets/img/banner-profil.png); background-size: cover; background-position: center center;">
</div>
