...
<div class="container">
<div class="carousel slide hero-card reveal" data-banner-placement="homepage" data-bs-ride="carousel" id="heroCarousel">
...
<img alt="Banner Teakwave 1" class="hero-slide-img" decoding="async" loading="eager" src="./assets/img/banner-home-1.png"/>
</div>
</div>
<div class="carousel-item">
<div class="hero-slide hero-image-slide text-center">
<img alt="Banner Teakwave 2" class="hero-slide-img" decoding="async" loading="lazy" src="./assets/img/banner-home-2.png"/>
</div>
</div>
<div class="carousel-item">
<div class="hero-slide hero-image-slide text-center">
<img alt="Banner Teakwave 3" class="hero-slide-img" decoding="async" loading="lazy" src="./assets/img/banner-home-3.png"/>
</div>
</div>
</div>
<button aria-label="Slide sebelumnya" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#heroCarousel" type="button">
<span aria-hidden="true" class="carousel-control-prev-icon"></span>
</button>
<button aria-label="Slide berikutnya" class="carousel-control-next" data-bs-slide="next" data-bs-target="#heroCarousel" type="button">
...
<button aria-label="Previous product" class="btn" data-bs-slide="prev" data-bs-target="#productCarousel" type="button"><i class="bi bi-arrow-left"></i></button>
<button aria-label="Next product" class="btn" data-bs-slide="next" data-bs-target="#productCarousel" type="button"><i class="bi bi-arrow-right"></i></button>
</div>
</div>
