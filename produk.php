...
<div class="produk-hero-visual" data-banner-placement="product" style="background: url(./assets/img/banner-profil.png); background-size: cover; background-position: center center;">
</div>
